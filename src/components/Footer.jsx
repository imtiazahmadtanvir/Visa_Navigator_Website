    ...
    <footer className="bg-background border-t border-border">
      <div className="container mx-auto px-6 py-12">
          ...
          <div className="md:col-span-1">
            ...
            >
              <Link to="/" className="flex items-center">
                ...
                <span className="text-xl font-bold text-foreground">Visa Navigator</span>
              </Link>
        ...
        <div className="border-t border-border pt-8 pb-6">
          <div className="max-w-md mx-auto md:mx-0">
            <h3 className="text-foreground font-semibold mb-3 text-lg">Subscribe to our newsletter</h3>
            ...
            <form className="flex gap-2">
              <input
                type="email"
                placeholder="Your email address"
                className="flex-1 px-4 py-2 border border-border rounded-md focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent bg-input text-foreground placeholder-muted-foreground"
                required
                aria-label="Email for newsletter"
              />
              <motion.button
