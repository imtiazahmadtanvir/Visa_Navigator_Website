    ...
    <div className="bg-gray-100 dark:bg-gray-900 text-gray-700 dark:text-gray-300 shadaw-lg">
      <footer className="footer footer-center bg-base-200 dark:bg-gray-800 text-base-content dark:text-gray-200 p-10">
        ...
        <nav className="grid grid-flow-col gap-4">
          ...
          <Link to="/contact" className="link link-hover hover:text-gray-500 dark:hover:text-gray-400">
            Contact
          </Link>
          <Link to="/jobs" className="link link-hover hover:text-gray-500 dark:hover:text-gray-400">
            Jobs
          </Link>
          <Link to="/press-kit" className="link link-hover hover:text-gray-500 dark:hover:text-gray-400">
            Press kit
          </Link>
        </nav>
